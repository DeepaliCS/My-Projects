...
public class SimpleGeneticAlgorithm
{
	...
	//EXPLANATION
	//Children get parents genes, how many the 'xopos' value is generated
	
	
	//Do Uniform Crossover - as in the lectures - COMPLETE
//______________________________________________________________________________________
	...
	//EXPLANATION:
	//Child 1 and 2 get the genes from different parents if 'rand' equals 1
	//otherwise it will be oppsite if rand is '0'
//______________________________________________________________________________________
