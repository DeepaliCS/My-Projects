...
writer = pd.ExcelWriter(r'C:\Users\deepa\Desktop\excelDump\results.xlsx', engine='xlsxwriter')

# Write each dataframe to a different worksheet.
query1.to_excel(writer, sheet_name='Sheet1')

# Close the Pandas Excel writer and output the Excel file.
writer.save()

os.startfile(r'C:\Users\deepa\Desktop\excelDump\results.xlsx')
